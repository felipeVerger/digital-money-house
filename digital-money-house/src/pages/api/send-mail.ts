...
export default async function handler(
  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        <td style="padding:18px 0px 18px 0px; line-height:20px; text-align:inherit; background-color:#201f22;" height="100%" valign="top" bgcolor="#201f22" role="module-content"><div><h4 style="text-align: center"><span style="white-space: pre-wrap; color: #ffffff; font-size: 18px">Recibimos tu solicitud de registro.</span><span style="color: #ffffff; font-size: 18px"><br>
  </span><span style="white-space: pre-wrap; color: #ffffff; font-size: 18px">Por favor completalo ingresando el siguiente código en el sitio</span><span style="color: #ffffff; font-size: 18px">&nbsp;</span></h4><div></div></div></td>
      </tr>
    </tbody>
