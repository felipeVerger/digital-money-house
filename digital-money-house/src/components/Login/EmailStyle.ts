...
export const Input = styled.input<Input>`
    ...
    border-radius: 10px;
    margin-bottom: 20px;
    border: ${(props) => props.error ? `1px solid ${themes.light.error}` : '1px solid #D2FFEC'};
    ...
    &:focus{
        outline: none;
        border: ${(props) => props.error ? `1px solid ${themes.light.error}` : `1px solid ${themes.light.secondary}`};
    };  
